...
%   cortex. bioRxiv (2022)
%
% Written and edited by G Handy, IA Oldenburg, and WD Hendricks 10/14/2022
%%
clear; close all; clc;
...
restoredefaultpath;
folder = fileparts(which('analyzeAndCompressData_2d.m')); 
...
for outer_loop = 1:length(loadList_all) %10 for 60 offTarget
    ...
    [All,opts,outVars] = loadData_2d(loadList,loadPath);
    ...
    [All, outVars] = defineDistanceTypes_2d(All, outVars);
...
save('compressedData/cellTable250622_2d.mat')
...
writetable(cellTable, 'compressedData/cell_table_250622_2d.csv')